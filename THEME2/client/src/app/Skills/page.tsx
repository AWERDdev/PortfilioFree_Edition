...
export default function SkillsPage() {
  ...
  return (
    <main className="w-screen min-h-screen bg-gradient-to-r from-black to-gray-900 transition duration-300 overflow-x-hidden text-gray-200">
      ...
      <section className="px-5 sm:px-10 mt-20 mb-10 text-center">
        <h1 className="text-xl sm:text-3xl font-bold text-green-500">{"<Skills />"}</h1>
      </section>
      ...
      <section className="grid grid-cols-1 lg:grid-cols-2 gap-10 px-5 sm:px-10">
        ...
        <div className="bg-gray-900 p-6 rounded-2xl shadow-lg">
          <h2 className="text-2xl font-bold text-green-500 mb-2">Toolbox</h2>
          ...
          <div className="flex flex-wrap gap-3">
            {[ // Code Editors & IDEs
              ...
              // Productivity
              "Notion", "Trello", "Slack", "Raycast"
            ].map((tool, idx) => (
              <span key={idx} className="bg-green-900/30 text-xs text-green-400 font-semibold px-3 py-1 rounded-full shadow">
                {tool}
              </span>
            ))}
          </div>
