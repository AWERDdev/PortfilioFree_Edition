...
export default function Home() {
  ...
  return (
    <main className="w-screen min-h-screen bg-gradient-to-r from-gray-50 to-white transition duration-300 overflow-x-hidden">
      {/* Navigation Bar */}
      ...
      <section className="DescribtionTitle flex justify-evenly items-center mt-32 px-4 flex-wrap">
        <div className="Image relative w-[180px] h-[180px] flex items-center justify-center rounded-full bg-gray-50 overflow-hidden">
        ...
        <div className="context text-gray-800">
          ...
          <h2 className="text-orange-500 font-semibold mb-3">Specializing in Full-Stack Development</h2>
          ...
          <div className="flex gap-4">
            <button
              ...
              className="bg-orange-500 hover:bg-orange-600 text-white px-3 py-2 md:px-5 md:py-2 rounded-md transition cursor-pointer"
            >
              Get InTouch
            </button>
            <button
              onClick={() => handleNavigation({ url: projectsURL })} // Navigate to 'View Projects'
              className="border border-orange-500 text-orange-500 px-5 py-2 rounded-md hover:bg-orange-50 transition cursor-pointer"
            >
              ViewProjects
            </button>
          </div>
