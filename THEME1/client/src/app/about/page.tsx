...
export default function AboutPage() {
  return (
    <main className="w-screen min-h-screen bg-gradient-to-b from-[#0f172a] to-[#1e293b] text-white transition duration-300 overflow-x-hidden">
      ...
      <section className="grid grid-cols-1 lg:grid-cols-2 gap-10 px-5 sm:px-10 mt-16 mb-20">
        ...
        <div className="Timeline">
          <h2 className="text-2xl sm:text-3xl font-bold text-[#9333ea] mb-8">
            My Journey
          </h2>

          <ol className="relative border-l-4 border-[#9333ea] ml-4">
            {/* Timeline Item 1 */}
            <li className="mb-12 ml-6">
              <span className="absolute -left-4 w-8 h-8 bg-[#9333ea] rounded-full ring-8 ring-[#1e293b] animate-pulse flex items-center justify-center" />
